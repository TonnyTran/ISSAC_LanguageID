...
all_feats="ark,s,cs:apply-cmvn-sliding --norm-vars=true --center=true --cmn-window=300 scp:$data/feats.scp ark:- | select-voiced-frames ark:- scp,s,cs:$data/vad.scp ark:- |"
feats="ark,s,cs:apply-cmvn-sliding --norm-vars=true --center=true --cmn-window=300 scp:$sdata/JOB/feats.scp ark:- | select-voiced-frames ark:- scp,s,cs:$sdata/JOB/vad.scp ark:- | subsample-feats --n=$subsample ark:- ark:- |"
