...
## Set up features.
feats="ark,s,cs:apply-cmvn-sliding --norm-vars=true --center=true --cmn-window=300 scp:$sdata/JOB/feats.scp ark:- | extract-feature-segments --snip-edges=false --frame-shift=10 ark:- $data/marks ark:- |"
