...
## Set up features.
feats="ark,s,cs:apply-cmvn-sliding --norm-vars=true --center=true --cmn-window=300 scp:$sdata/JOB/feats.scp ark:- | select-voiced-frames ark:- scp,s,cs:$sdata/JOB/vad.scp ark:- |"
